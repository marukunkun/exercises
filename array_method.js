...
// Create an extendable calculator
  ...
  function Calculator() {
    ...
    this.calculate = function(str) {
      ...
      if (!this.methods[operator] || isNaN(n1) || isNaN(n2)) {
        return NaN
      }
      
      return this.methods[operator](n1, n2)
    }
  ...
  casio.addMethod("*", (a, b) => a * b)
  casio.addMethod("/", (a, b) => a / b)
  casio.addMethod("**", (a, b) => a ** b)
  
  let result = casio.calculate("2 ** 5")
  console.log(result)
...
// Shuffle an array
  ...
  function shuffle(arr) {
    ...
    while (arr.length > 0) {
    	...
    	let newInput = arr.splice(randomIndex, 1)
...
// Get average age
  ...
  function getAverageAge(arr) {
    return arr.reduce((a,c) => a + c.age, 0) / arr.length
  }
