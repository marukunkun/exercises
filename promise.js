// Re-resolve a promise?
    ...
    promise.then(alert)  // 1, only the first resolve/reject is return. The rest is ignore because we already have your callback result.
